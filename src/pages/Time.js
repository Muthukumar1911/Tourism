...
import "./Time.css"
import image1 from "../Imags/Climate.jpeg"
import Image from "react-bootstrap/Image";
import Acco1 from "../Imags/image.jpeg"
import Acco2 from "../Imags/image1.jpeg"
import Acco3 from "../Imags/image2.jpeg"
import Chennai1 from "../Imags/chennai1.jpeg"
import Chennai2 from "../Imags/chennai2.jpeg"
import Chennai3 from "../Imags/chennai3.jpeg"
import Rameshwaram1 from "../Imags/rameshwaram1.jpeg"
import Rameshwaram2 from "../Imags/rameshwaram2.jpeg"
import Rameshwaram3 from "../Imags/rameshwaram3.jpeg"
import Hogenakkal1 from "../Imags/hogenakkal1 (1).jpeg"
import Hogenakkal2 from "../Imags/hogenakkal1 (2).jpeg"
import Hogenakkal3 from "../Imags/hogenakkal1 (3).jpeg"
import Kanyakumari1 from "../Imags/kanyakumari1 (1).jpeg"
import Kanyakumari2 from "../Imags/kanyakumari1 (2).jpeg"
import Kanyakumari3 from "../Imags/kanyakumari1 (3).jpeg"
import Kodaikanal1 from "../Imags/kodaikanal1.jpeg"
import Kodaikanal2 from "../Imags/kodaikanal2.jpeg"
import Kodaikanal3 from "../Imags/kodaikanal3.jpeg"
import Kumbakonam1 from "../Imags/kumbakonam1.jpeg"
import Kumbakonam2 from "../Imags/kumbakonam2.jpeg"
import Kumbakonam3 from "../Imags/kumbakonam3.jpeg"
import Madurai1 from "../Imags/madurai1.jpeg"
import Madurai2 from "../Imags/madurai2.jpeg"
import Madurai3 from "../Imags/madurai3.jpeg"
import Ooty1 from "../Imags/ooty1.jpeg"
import Ooty2 from "../Imags/ooty2.jpeg"
import Ooty3 from "../Imags/ooty3.jpeg"
import Theni1 from "../Imags/theni1.jpeg"
import Theni2 from "../Imags/theni2.jpeg"
import Theni3 from "../Imags/theni3.jpeg"
import Yercaud1 from "../Imags/yercaud1.jpeg"
import Yercaud2 from "../Imags/yercaud2.jpeg"
import Yercaud3 from "../Imags/yercaud3.jpeg"
...
const Time = () => {
    ...
    return(
                ...
                <Accordion defaultActiveKey="">
                    ...
                    <Accordion.Item eventKey="2">
                        <Accordion.Header>Tamil Nadu In Winter (October - February)</Accordion.Header>
                            ...
                            <Image className="Accordian-image" src={Acco3}></Image><span className="centeeer">Pechiparai Reservoir in Kanyakumari District Source</span>
                            </Accordion.Body>
                    </Accordion.Item>
                </Accordion>
                </Col>
        ...
        <Container>
            <p id="para-top-top">&emsp;&emsp;&emsp;&emsp;The best time to visit Tamil Nadu is during the winter season, ie, from November to February when the temperature is relatively low, and pleasant to explore the attractions in the state. Monsoons bring torrential downpour which makes it an inappropriate time to travel through Tamil Nadu. Summer, however, is perfect for exploring the hills stations. Tourists can pick the region they wish to see according to the season because offseason visits could be extremely inconvenient for some.</p>
        </Container><br></br><br></br><br></br><br></br><br></br>

        <Container><h3>TAMILNADU TOURISM</h3>
        <h6 id="best-time-to-visit">Best Time to Visit</h6></Container><br></br><br></br><br></br>
        
        
        
        <Container>
            <Row>
                <Col className="text-start"><br></br>
                <h2 style={{fontWeight : "600"}}>01. Chennai</h2><br></br>
                    <h6 className="para-heading">What is the best time to visit:</h6>
                    <p>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;October to February during the winters and the pre-monsoons season is the best time to visit Chennai. This time of the year is considered as the best time to explore the metropolitan city as summers are scorching and monsoons bring torrential downpours and cyclones. Its geographical location on the beautiful coastline mostly keeps the city's weather hot and humid.</p>
                    <p>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;Chennai is one of the cities that has successfully blended the modern, traditional and sides with ease. The city welcomes everyone who wants to seek a soulful and spiritual connection but also those who love shopping for sarees and enjoy good food. There is no conundrum in Chennai when you visit. It's all about the moment, whether you decide to take a stroll down Marina Beach.</p>
                </Col>
                
                <Col>
                <div className="modal show" show={true} style={{ display: 'block', position: 'relative' }} >
                    <Modal.Dialog >
        ...
        <Container className="text-start"><h2 style={{fontWeight : "600"}}>02. Rameshwaram</h2></Container><br></br>
        <Container>
            <Row>
                <Col>
                <div className="modal show" style={{ display: 'block', position: 'initial' }}>
                    <Modal.Dialog>
                        ...
                        <Container>
                                <Row>
                                    <Col><Image className="modal-image" src={Rameshwaram1}></Image><p className="text-center">Railway<br></br>Bridge<br></br> Source</p></Col>
                                    <Col><Image className="modal-image" src={Rameshwaram2}></Image><p className="text-center">Lighthouse<br></br>Source</p></Col>
                                    <Col><Image className="modal-image" src={Rameshwaram3}></Image><p className="text-center">Pilgrims<br></br>Temple<br></br>Source</p></Col>
                                </Row>
                            </Container>
                        </Modal.Body>
                    ...
                    <Offcanvas show={show2} onHide={handleClose2} placement="end">
                        <Offcanvas.Header closeButton>
                            <Offcanvas.Title className="text-center"><h5 className="offcanvas-heading">Best Time To Visit In Rameshwaram</h5>
                            </Offcanvas.Title>
                        </Offcanvas.Header>
                            <Offcanvas.Body>
                                <h6>Rameshwaram in Winters (November - February)</h6><br></br>
                                <p>&emsp;&emsp;&emsp;&emsp;Winters in Rameshwaram, which last from October all the way to March, is said to be the peak season for visiting Rameshwaram if you are visiting the place as a tourist and not a pilgrim. The temperature during these months drops considerably than the other two seasons, with it ranging from 20 degree Celsius to 30 degree Celsius. The town is also blessed with chilly winds which make the atmosphere even more amicable. This season, therefore, makes for the best time for tourists to take part in a plethora of outdoor activities and enjoy their stay. During December, Rameshwaram also hosts the festival of Arudhra Darshanam which is essentially a festival that celebrates an aspect of Lord Shiva. This is said to be one of the most celebrated festivals amongst all the ones celebrated in Rameshwaram.</p><br></br><br></br>

                                <h6>Rameshwaram in Summers (March - June)</h6><br></br>
                                <p>&emsp;&emsp;&emsp;&emsp;March marks the onset of the summer season in Chennai. It lasts till June and visiting the city during this time is not for the faint- hearted, some say. The days are blazing hot with the temperatures soaring as high as 39°C and the nights are equally warm with the minimum hovering around 27°C. Exploring the cityscape during this time of the year is an extremely exhausting affair and is, therefore, not advised to tourists.</p><br></br><br></br>

                                <h6>Rameshwaram in Monsoons (July-September)</h6><br></br>
                                <p>&emsp;&emsp;&emsp;&emsp;Chennai is susceptible to heavy downpours and cyclones between the months of July and September. These months mark the monsoon season in the region and is considered off-season as tourism does not really thrive here. The extreme rainfalls and strong winds could prove to be a hindrance to sightseeing and, therefore, the monsoon season is not recommended to tourists. The hotel tariffs, however, drop drastically during the season, making it a decent option for budget travellers. In case one has to visit Chennai, they may want to plan a trip at the onset of the season when the showers are moderate and allow travelling through the city.</p><br></br>
                            </Offcanvas.Body>
                    </Offcanvas>
                </div>
        ...
        <Container>
            <Row>
                ...
                <h2 style={{fontWeight : "600"}}>03. Kodaikanal</h2><br></br><br></br>
                    ...
                    <p>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;Kodaikanal is lovingly referred to as The Princess of Hill stations. And boy, does it take this title seriously! Built around an exotic star shaped lake, the region exudes ethereal charm like that of fairy-tales. The best time to visit Kodaikanal is from October - June, however, the weather remains a bit chilly during December and January.</p>
                </Col>
                ...
                <div className="modal show" style={{ display: 'block', position: 'relative' }}>
                    <Modal.Dialog>
                        ...
                        <Container>
                                <Row>
                                    <Col><Image className="modal-image" src={Kodaikanal1}></Image><p className="text-center">Upper Lake<br></br> Source</p></Col>
                                    <Col><Image className="modal-image" src={Kodaikanal2}></Image><p className="text-center">Kodaikanal<br></br>Lake<br></br> Source</p></Col>
                                    <Col><Image className="modal-image" src={Kodaikanal3}></Image><p className="text-center">Pillar<br></br>Rocks<br></br>Source</p></Col>
                                </Row>
                            </Container>
                        </Modal.Body>
                    ...
                    <Offcanvas show={show3} onHide={handleClose3}>
                        <Offcanvas.Header closeButton>
                            <Offcanvas.Title className="text-center"><h5 className="offcanvas-heading">Best Time To Visit In Kodaikanal</h5>
                           
                            </Offcanvas.Title>
                        </Offcanvas.Header>
                            <Offcanvas.Body>
                                <h6>Kodaikanal in Summer (March-June)</h6><br></br>
                                <p>&emsp;&emsp;&emsp;&emsp;Summers (March to June) in Kodaikanal is ideal with comfortable 20 degree Celsius to 32 degree Celsius temperature and flowers in full bloom. The ten days long Grand Annual Summer Festival, which takes place in May, attracts many tourists. From elegant fruit exhibitions to enthralling boat races, flower art- works, classical dance performances and melodious musicals, the Summer Festival is a platter of different shows. Kodaikanal also holds fantastic festivals like Panguni Uthiram in March and the Annual Horticulture Show in May.</p><br></br><br></br>

                                <h6>Kodaikanal in Winter (December-February)</h6><br></br>
                                <p>&emsp;&emsp;&emsp;&emsp;Summers (March to June) in Kodaikanal is ideal with comfortable 20 degree Celsius to 32 degree Celsius temperature and flowers in full bloom. The ten days long Grand Annual Summer Festival, which takes place in May, attracts many tourists. From elegant fruit exhibitions to enthralling boat races, flower art- works, classical dance performances and melodious musicals, the Summer Festival is a platter of different shows. Kodaikanal also holds fantastic festivals like Panguni Uthiram in March and the Annual Horticulture Show in May.</p><br></br>

                                <h6>Kodaikanal in Monsoon (June-September)</h6><br></br>
                                <p>&emsp;&emsp;&emsp;&emsp;With a temperature that rarely falls below 8 degree Celsius, winter in Kodaikanal (between December and February) is the best time to enjoy various treks, and attend the famous Pongal festival celebrated during January.</p><br></br>
                            </Offcanvas.Body>
                    </Offcanvas>
                </div>
                </Col>
        ...
        <Container className="text-start"><h2 style={{fontWeight : "600"}}>04. Ooty</h2></Container><br></br>
        <Container>
            <Row>
                <Col>
                <div className="modal show" style={{ display: 'block', position: 'initial' }}>
                    <Modal.Dialog>
                        ...
                        <Container>
                                <Row>
                                    <Col><Image className="modal-image" src={Ooty1}></Image><p className="text-center">Mountain<br></br>Railway<br></br> Source</p></Col>
                                    <Col><Image className="modal-image" src={Ooty2}></Image><p className="text-center">Ooty Lake<br></br> Source</p></Col>
                                    <Col><Image className="modal-image" src={Ooty3}></Image><p className="text-center">Trekking Ooty<br></br> Source</p></Col>
                                </Row>
                            </Container>
                        </Modal.Body>
                    ...
                    <Offcanvas show={show4} onHide={handleClose4} placement="end">
                        <Offcanvas.Header closeButton>
                            <Offcanvas.Title className="text-center"><h5 className="offcanvas-heading">Best Time To Visit In Ooty</h5>
                          
                            </Offcanvas.Title>
                        </Offcanvas.Header>
                            <Offcanvas.Body>
                                <h6>Ooty in Summer (March - June)</h6><br></br>
                                <p>&emsp;&emsp;&emsp;&emsp;Ooty experiences an average temperature that ranges between 23 degree Celsius and 31 degree Celsius, which is perfect for you to explore the sheer beauty of this place in full swing.</p><br></br><br></br>

                                <h6>Ooty in Winter (October - March)</h6><br></br>
                                <p>&emsp;&emsp;&emsp;&emsp;With temperatures that stay below 15 degree Celsius, winters in Ooty are perfect to have a gala time. Each year, during January or February, Department of Tourism in Tamil Nadu hosts The Tea and Tourism Festival for three days. A vast range of tea leaves are displayed, and rows of tea stalls are put up for tasting and buying a wide variety of tea. In addition to this, these three days are packed with cultural shows and performances, which reverberate with the heritage of the Nilgiris.</p><br></br><br></br>

                                <h6>Ooty in Monsoon (July-September)</h6><br></br>
                                <p>&emsp;&emsp;&emsp;&emsp;People who love rainfall and green grass beds laid over mountains can pack their bags and head straight to Ooty during the monsoon months, which lasts between June and September. Even though you are unlikely to experience the bright, warm sunshine, you will have a great time nevertheless</p><br></br>
                            </Offcanvas.Body>
                    </Offcanvas>
                </div>
                </Col>
                ...
                <h6 className="text-start para-heading">What is the best time to visit:</h6>
                    ...
                    <p>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;The poised and elegant 'Queen of Hill Stations welcomes you to the kingdom in the clouds. Individuals travel far and wide to partake in the awe-inspiring wonders of one of India's most beloved hill stations - Ootacamund or Ooty. Here, history and culture form a sweet medley, while nature sings to its own symphony. Colonial churches, Hindu temples, tribal museums and libraries brand the plains with stories.</p>
                </Col>
            </Row>
        </Container><br></br><br></br><br></br><br></br>
        ...
        <Container>
            <Row>
                ...
                <h2 style={{fontWeight : "600"}}>05. Kanyakumari</h2><br></br><br></br>
                    <h6 className="para-heading">What is the best time to visit:</h6>
                    <p>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;The months from October until February are considered the best time to visit Kanyakumari, as the weather remains calm and pleasant. Although this coastal region is a bit humid, this is the best time to try out some adventurous water sports, going on sightseeing and outings, undertaking beach activities and savouring the spectacular sunset views. With the beginning of winters in November, Kanyakumari also hosts many festivals during this month, for instance the Cape Festival.</p>
                    <p>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;Kanyakumari is the southernmost tip of India. As Kanyakumari is close to the seas, the expanse experiences a tropical coastal climate. There are not many variations in the seasons, as there is an overall humidity and seasonal rain during the year.</p>
                </Col>
                ...
                <div className="modal show" style={{ display: 'block', position: 'relative' }}>
                    <Modal.Dialog>
                        ...
                        <Container>
                                <Row>
                                    <Col><Image className="modal-image" src={Kanyakumari1}></Image><p className="text-center">Landscape<br></br> Source</p></Col>
                                    <Col><Image className="modal-image" src={Kanyakumari2}></Image><p className="text-center">Sea<br></br> Source</p></Col>
                                    <Col><Image className="modal-image" src={Kanyakumari3}></Image><p className="text-center">Coast<br></br> Source</p></Col>
                                </Row>
                            </Container>
                        </Modal.Body>
            ...
            <Row>
                ...
                <div className="modal show" style={{ display: 'block', position: 'initial' }}>
                    <Modal.Dialog>
                        ...
                        <Container>
                                <Row>
                                    <Col><Image className="modal-image" src={Kumbakonam1}></Image><p className="text-center">Dawn<br></br> Source</p></Col>
                                    <Col><Image className="modal-image" src={Kumbakonam2}></Image><p className="text-center">Steemit<br></br> Source</p></Col>
                                    <Col><Image className="modal-image" src={Kumbakonam3}></Image><p className="text-center">Holydham<br></br> Source</p></Col>
                                </Row>
                            </Container>
                        </Modal.Body>
                    ...
                    <Offcanvas show={show6} onHide={handleClose6} placement="end">
                        <Offcanvas.Header closeButton>
                            <Offcanvas.Title className="text-center"><h5 className="offcanvas-heading">Best Time To Visit In Kumbakonam</h5>
                        
                            </Offcanvas.Title>
                        </Offcanvas.Header>
                            <Offcanvas.Body>
                                <h6>Kumbakonam in Winter (October - February)</h6><br></br>
                                <p>&emsp;&emsp;&emsp;&emsp;The winters in Kumbakonam are pleasantly cold, with light sweaters helping you to survive the cold. The temperature ranges from 15 to 25 degrees Celcius, and the diurnal range of temperature isn't more than a maximum of 10 degrees Celcius. This season is most preferred by tourists to visit Kumbakonam, as exploring the city in this weather becomes comfortable and the temperature is pleasing most of the time during winter months.</p><br></br><br></br>

                                <h6>Kumbakonam in Monsoon (June-August)</h6><br></br>
                                <p>&emsp;&emsp;&emsp;&emsp;The monsoon is associated with frequent and untimely shower spells in the region. The temperature drops down considerably after the scorching summers and the place witness a waste stretch of greenery as the rains give life to the flora of the region. The rains can though be problematic at times and can interfere with your exploration plans, but overall this season can also be preferred by tourists to pay a visit to Kumbakonam.</p><br></br><br></br>

                                <h6>Kumbakonam in Summer (March-May)</h6><br></br>
                                <p>&emsp;&emsp;&emsp;&emsp;Summers in the Deccan region of the country is undeniable hot, and the scorching sun might be an unpleasant experience. The summers are usually arid and heated up, and the temperature goes up to 40 degrees Celcius during the day. The season is majorly avoided by tourists to plan a visit to Kumbakonam because of the overall weather conditions.</p><br></br>
                            </Offcanvas.Body>
                    </Offcanvas>
                </div>
                </Col>
        ...
        <Container>
            <Row>
                ...
                <h2 style={{fontWeight : "600"}}>07. Madurai</h2>
                    <h6 className="para-heading">What is the best time to visit:</h6>
                    <p>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;October to March is the best time to visit Madurai. With a hot and dry climate for most of the year, Madurai is best visited during the winter season. The town is known for its ancient temples and other architectural and religious masterpieces and receives a generous crowd of people throughout the year. Madurai is the most fascinating and welcoming during the months between October and March which coincides with its winter season.</p>
                    <p>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;Madurai is one of the oldest culturally vibrant cities of India. Its historical places and temples have a steady flow of tourists from all around the world.</p>
                </Col>
                ...
                <div className="modal show" style={{ display: 'block', position: 'relative' }}>
                    <Modal.Dialog>
                        ...
                        <Container>
                                <Row>
                                    <Col><Image className="modal-image" src={Madurai1}></Image><p className="text-center">Meenatchi<br></br>Amman<br></br> Source</p></Col>
                                    <Col><Image className="modal-image" src={Madurai2}></Image><p className="text-center">Madurai<br></br>Garden<br></br> Source</p></Col>
                                    <Col><Image className="modal-image" src={Madurai3}></Image><p className="text-center">Murugan<br></br>Temple<br></br> Source</p></Col>
                                </Row>
                            </Container>
                        </Modal.Body>
            ...
            <Row>
                ...
                <div className="modal show" style={{ display: 'block', position: 'initial' }}>
                    <Modal.Dialog>
                        ...
                        <Container>
                                <Row>
                                    <Col><Image className="modal-image" src={Yercaud1}></Image><p className="text-center">Easemytrip<br></br> Source</p></Col>
                                    <Col><Image className="modal-image" src={Yercaud2}></Image><p className="text-center">Oyorooms<br></br> Source</p></Col>
                                    <Col><Image className="modal-image" src={Yercaud3}></Image><p className="text-center">Hiveminer<br></br> Source</p></Col>
                                </Row>
                            </Container>
                        </Modal.Body>
                    ...
                    <Offcanvas show={show8} onHide={handleClose8} placement="end">
                        <Offcanvas.Header closeButton>
                            <Offcanvas.Title className="text-center"><h5 className="offcanvas-heading">Best Time To Visit In Yercaud</h5>
                    
                            </Offcanvas.Title>
                        </Offcanvas.Header>
                            <Offcanvas.Body>
                                <h6>Yercaud in Summer (March - June)</h6><br></br>
        ...
        <Container>
            <Row>
                <Col className="text-start">
                <h2 style={{fontWeight : "600"}}>09. Theni</h2><br></br><br></br>
                    <h6 className="para-heading">What is the best time to visit:</h6>
                    <p>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;In order to spend your vacation in the lap of nature in south India, no place would be better than the town of Cardamom - Theni. The best season to visit Theni is winter when the weather remains all pleasant and favourable for tourism. On the other hand, summer remains hot and monsoon receives a heavy rainfall which makes the two seasons not suitable for touring.</p>
                    <p>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;Theni is known for having a salubrious climate throughout the year. The average temperature ranges between 15 degrees Celsius to 40 degrees Celsius. The best months to visit are from the month of December to February since the weather is pleasant and allows you to indulge in a number of outdoor activities.</p>
                </Col>
                ...
                <div className="modal show" style={{ display: 'block', position: 'relative' }}>
                    <Modal.Dialog>
                        ...
                        <Container>
                                <Row>
                                    <Col><Image className="modal-image" src={Theni1}></Image><p className="text-center">Suruli<br></br> Source</p></Col>
                                    <Col><Image className="modal-image" src={Theni2}></Image><p className="text-center">Meghamalai<br></br> Source</p></Col>
                                    <Col><Image className="modal-image" src={Theni3}></Image><p className="text-center">Mullai<br></br>Periyar<br></br> Source</p></Col>
                                </Row>
                            </Container>
                        </Modal.Body>
                    ...
                    <Offcanvas show={show9} onHide={handleClose9}>
                        <Offcanvas.Header closeButton>
                            <Offcanvas.Title className="text-center"><h5 className="offcanvas-heading">Best Time To Visit In Theni</h5>
                           
                            </Offcanvas.Title>
                        </Offcanvas.Header>
                            <Offcanvas.Body>
                                <h6>Theni in Summer</h6><br></br>
                                <p>&emsp;&emsp;&emsp;&emsp;The summer season in Theni starts from the month of March and continues till May. The months are generally hot and not favourable to visit Theni. Temperature during these months ranges between 24°C and 42°C.</p><br></br><br></br>

                                <h6>Theni in Winter</h6><br></br>
                                <p>&emsp;&emsp;&emsp;&emsp;Monsoon in Theni strikes in the month of June and lasts until September. The town experiences a heavy rainfall during this time that fills the town with zest. Despite being at peak of its beauty, the town of Theni is not best to visit during monsoon.</p><br></br><br></br>

                                <h6>Theni in Monsoon</h6><br></br>
                                <p>&emsp;&emsp;&emsp;&emsp;December marks the beginning of winter season in Theni which ends in the month of February. The temperature during these months varies from 22°C to 32°C, and thus, the town witnesses a pleasant weather and make the season best to visit Theni.</p><br></br>
                            </Offcanvas.Body>
                    </Offcanvas>
                </div>
                </Col>
            ...
            <Row>
                ...
                <div className="modal show" style={{ display: 'block', position: 'initial' }}>
                    <Modal.Dialog>
                        ...
                        <Container>
                                <Row>
                                    <Col><Image className="modal-image" src={Hogenakkal1}></Image><p className="text-center">Winter<br></br> Source</p></Col>
                                    <Col><Image className="modal-image" src={Hogenakkal2}></Image><p className="text-center">Monsoon<br></br> Source</p></Col>
                                    <Col><Image className="modal-image" src={Hogenakkal3}></Image><p className="text-center">Dry<br></br> Source</p></Col>
                                </Row>
                            </Container>
                        </Modal.Body>
